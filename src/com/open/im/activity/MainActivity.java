...
public class MainActivity extends Activity implements OnClickListener {
	...
	private void initData() {
		...
		// 给标题栏弹窗添加子类
		titlePopup.addAction(new ActionItem(act, "发起聊天", R.drawable.mm_title_btn_compose_normal));
		titlePopup.addAction(new ActionItem(act, "听筒模式", R.drawable.mm_title_btn_receiver_normal));
		titlePopup.addAction(new ActionItem(act, "登录网页", R.drawable.mm_title_btn_keyboard_normal));
		titlePopup.addAction(new ActionItem(act, "扫一扫", R.drawable.mm_title_btn_qrcode_normal));
